...
# o iOS procura /apple-touch-icon.png na raiz quando não encontra a tag <link>
make(180).save("apple-touch-icon.png", "PNG", optimize=True)
# tamanhos que o iOS pede em iPad/retina antigos, e o nome legado
for s2, n2 in [(152, "apple-touch-icon-152.png"),
               (167, "apple-touch-icon-167.png"),
               (180, "apple-touch-icon-precomposed.png"),
               (192, "app-icon-192.png")]:
    make(s2).save(n2, "PNG", optimize=True)
